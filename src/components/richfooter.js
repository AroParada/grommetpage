  ...
  const data = [
    {
      ...
      github: (
        <Anchor
          href="https://github.com/jamescbaldwin/react-finance/tree/aro"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Github />}
      ...
      link: (
        <Anchor
          href="https://stark-tor-31756.herokuapp.com/"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Link />}
      ...
      summary:
        "Team built application that provides a dashboard to track crypto coins that users follow",
    ...
    },
    {
      ...
      github: (
        <Anchor
          href="https://github.com/AroParada/employeedirectory"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Github />}
      ...
      link: (
        <Anchor
          href="https://aroparada.github.io/employeedirectory/"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Link />}
      ...
      summary:
        "An employee directory that allows the user to filter list by last name or search box",
    ...
    },
    {
      ...
      github: (
        <Anchor
          href="https://github.com/nihalwill/EatingHour"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Github />}
      ...
      link: (
        <Anchor
          href="https://nihalwill.github.io/EatingHour/"
          target="_blank"
          rel="noopener"
          color="plain"
          icon={<Link />}
        ...
        <Grid gap="small" rows="fit" columns={{ count: "fit", size: "small" }}>
          {data.map((value) => (
            <Card
              ...
              key={value.id}
            >
              <CardBody height="small">{value.Image}</CardBody>
              <Box pad={{ horizontal: "medium" }} responsive={false}>
                <Heading level="3" margin={{ vertical: "medium" }}>
                  {value.title}
                </Heading>
                <Paragraph margin={{ top: "none" }}>{value.summary}</Paragraph>
              </Box>
              <CardFooter>
